...
@Mixin(StapiItemRenderer.class)
public class Dropped3DItemMixin {

    //Same as ArsenicItemRendererMixin but 3D, apply when there is 3D Dropped item mod
    @WrapOperation(method="render", at = {@At(value = "INVOKE", target = "Lorg/lwjgl/opengl/GL11;glRotatef(FFFF)V", ordinal = 1), @At(value = "INVOKE", target = "Lorg/lwjgl/opengl/GL11;glRotatef(FFFF)V", ordinal = 0)})
    ...
    @WrapOperation(method="render", at = @At(value = "INVOKE", target = "Lorg/lwjgl/opengl/GL11;glTranslatef(FFF)V", ordinal = 0))
    ...
    @WrapOperation(method="render", at = @At(value = "INVOKE", target = "Lorg/lwjgl/opengl/GL11;glTranslatef(FFF)V", ordinal = 1))
    ...
    @WrapOperation(method="render", at = @At(value = "INVOKE", target = "Lorg/lwjgl/opengl/GL11;glScalef(FFF)V", ordinal = 1))
